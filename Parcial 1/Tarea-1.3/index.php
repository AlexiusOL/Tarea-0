...
<body>
    ...
    <table border="1" cellspacing = "3" cellpadding = "3" >    
        ...
        <tr>
            <td colspan="2">8 <br> <pre>7.8  </pre></td>
            <td colspan="2"> <pre>$14848    </pre> </td>
        </tr>
        <tr>
            <td colspan="2">2 <br> <pre>8  </pre></td>
            <td colspan="2"> <pre>$3712    </pre> </td>
        </tr> 
    ...
    <?php 
        ...
        echo "<p> Materias: " . $a . "<br> Promedio: " . $b . "<br>";
